...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 14 mars 2024 à 12:20
...
--
-- Structure de la table `famille_de_risque`
--
...
--
-- Déchargement des données de la table `famille_de_risque`
--
...
(30, 'Risque lié aux vibrations (R-Vib)'),
...
(4, 'Biologique (R-Bio)'),
(1, 'Aération / Assainissement (R-A-A)');
...
--
-- Structure de la table `personne_exposees`
--
...
--
-- Déchargement des données de la table `personne_exposees`
--
...
--
-- Structure de la table `situation_dangereuse`
--
...
--
-- Déchargement des données de la table `situation_dangereuse`
--
...
--
-- Structure de la table `solution_de_la_situation`
--
...
--
-- Déchargement des données de la table `solution_de_la_situation`
--
...
--
-- Structure de la table `unite_de_travail`
--
...
--
-- Déchargement des données de la table `unite_de_travail`
--
...
--
-- Index pour la table `personne_exposees`
--
...
--
-- Index pour la table `probabilite`
--
...
--
-- AUTO_INCREMENT pour la table `famille_de_risque`
--
ALTER TABLE `famille_de_risque`
  MODIFY `Id_Famille_de_risque` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT pour la table `gravite`
--
ALTER TABLE `gravite`
  MODIFY `Id_Gravite` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `localisation`
--
ALTER TABLE `localisation`
  MODIFY `Id_Localisation` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `personne_exposees`
--
ALTER TABLE `personne_exposees`
  MODIFY `Id_personne_exposees` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `photos`
--
ALTER TABLE `photos`
  MODIFY `Id_Photos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `probabilite`
--
ALTER TABLE `probabilite`
  MODIFY `Id_Probabilite` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `risques`
--
ALTER TABLE `risques`
  MODIFY `Id_Risques` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `situation_dangereuse`
--
ALTER TABLE `situation_dangereuse`
  MODIFY `Id_Situation_dangereuse` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `solution_de_la_situation`
--
ALTER TABLE `solution_de_la_situation`
  MODIFY `Id_solution_de_la_situation` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `unite_de_travail`
--
ALTER TABLE `unite_de_travail`
  MODIFY `Id_Unite_de_travail` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=443;
