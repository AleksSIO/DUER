    ...
    <body style="background-color: white;">
        <div class="container">
            ...
            <table width="60%" align="center">
                    <tr>
                        <td align="center" colspan="4"><b><h3>Informations Gravite</h3></b></td>
                    </tr>
                    ...
                    <?php
                            ...
                            if($nb > 0) 
                            {
                                ...
                                while ($i<$nb)
                                {
                                    ...
                                    echo "<tr style='border-bottom:1pt solid black;' ><td><input type='checkbox' name='famille[]' value='$num'></td>";
                                    echo "<td>$num</td>";
                                    echo "<td>$famille</td>";
                                    echo "<td><a href='vue_famille_de_risque_modif.php?action=$num'><input class='btn btn-primary' type='button' value='Modifier'></a></td>";
                                    echo "</tr>";
                                    $i=$i+1;
                                }
                            }	
